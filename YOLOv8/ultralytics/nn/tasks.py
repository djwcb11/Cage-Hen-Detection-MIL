...
from .Addmodules import SEAM, SCDown, RepHead
import contextlib
...
def torch_safe_load(weight):
    """
    Attempts to load a PyTorch model with the torch.load() function, with fallback for missing modules.
    """
...
def parse_model(d, ch, verbose=True):  # model_dict, input_channels(3)
    ...
    for i, (f, n, m, args) in enumerate(d["backbone"] + d["head"]):  # from, number, module, args
        ...
        if m in (Classify, Conv, ConvTranspose, GhostConv, Bottleneck, GhostBottleneck, SPP, SPPF, DWConv, Focus,
                 ...
                 nn.ConvTranspose2d, DWConvTranspose2d, C3x, RepC3, RepConv, nn.Conv2d, SCDown):
            c1, c2 = ch[f], args[0]
